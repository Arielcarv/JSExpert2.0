class Business {
    ...
    onUserDisconnected = function() {
        return userId => {
            ...
            this.view.setParticipants(this.peers.size)  // Update participants
            this.stopRecording(userId)                  // Stop Recording
            this.view.removeVideoElement(userId)        // Remove Video element
        }
    }
    ...
    // If an user get in and out of the call during a recording, we need to stop the recordings.
